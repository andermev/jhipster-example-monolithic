...
To build the final jar and optimize the exampleMonolithic application for production, run:
...
[doing api-first development]: https://www.jhipster.tech/documentation-archive/v6.1.0/doing-api-first-development/
